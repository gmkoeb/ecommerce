...
class TestProductService:
    def test_list_products(self, test_db, products_service: ProductsService):
        ...
        first_product = products_repository.create_product(company_id=company.id, name="Gaming Keyboard", 
                                                           price=1000, model="Razer Bla", 
                                                           description="Gaming keyboard for games")
        second_product = products_repository.create_product(company_id=company.id, name="Gaming Keyboard", 
